  ...
  return (
    ...
    >
      ...
      <div className="gap-8 m-4">
        ...
        <p>Thunderdome: vote between projects others have made! After submitting your project, you must vote here in order to earn Scales.</p>
        <p>Shoppe: spend all your scales here! Get items, ranging from Blahajs to Yubikeys.</p>
      </div>
